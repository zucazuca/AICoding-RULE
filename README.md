...
# 5. 可选：把三权分离模块复制到项目（复制不等于启用）
powershell -NoProfile -ExecutionPolicy Bypass -File .\scripts\Install-AICodingRule.ps1 -ProjectPath E:\work\project\demo -IncludeThreeAuthorityWorkflow
```
